...
import img1 from "../pages/rooms/DeluxeACRoom/7.webp";
import img2 from "../pages/rooms/DeluxeACRoom/1.webp";
import img3 from "../pages/rooms/DeluxeACRoom/2.webp";
import img4 from "../pages/rooms/DeluxeACRoom/3.webp";
import img5 from "../pages/rooms/DeluxeACRoom/4.webp";
import img6 from "../pages/rooms/DeluxeACRoom/5.webp";
import img7 from "../pages/rooms/DeluxeACRoom/6.webp";
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Duplex A/C Room – Your Coastal Hideaway in Alibaug
            </p>
          </div>
