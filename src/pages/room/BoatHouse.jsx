...
import img2 from "../rooms/BoatHouse/2.webp";
import img3 from "../rooms/BoatHouse/3.webp";
import img4 from "../rooms/BoatHouse/4.webp";
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo('.gallery-item',
        { clipPath: 'polygon(0% 100%, 100% 100%, 100% 100%, 0% 100%)', opacity: 0 },
        {
          ...
          ease: 'power3.out',
          scrollTrigger: {
            trigger: '.mobile-slider', // Changed from '.gallery-grid'
            start: 'top 80%',
            toggleActions: 'play none none reverse'
          }
        }
      ...
      >
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Step inside our charming Boat House and experience the breathtaking beauty of nautical elegance.
            </p>
          </div>
