...
import img1 from "../rooms/DeluxeACRoom/7.webp";
import img2 from "../rooms/DeluxeACRoom/1.webp";
import img3 from "../rooms/DeluxeACRoom/2.webp";
import img4 from "../rooms/DeluxeACRoom/3.webp";
import img5 from "../rooms/DeluxeACRoom/4.webp";
import img7 from "../rooms/DeluxeACRoom/6.webp";
...
const DeluxeACRooms = () => {
  ...
  const images = [
    ...
    { src: img7, category: 'amenitiy' },
    { src: img4, category: 'bathroom' },
    { src: img5, category: 'bathroom' },
      ...
      >
        ...
        >
          ...
          <p className="hero-subtitle text-xl md:text-2xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed">
            Think beach getaway, but with double the charm. Our 2 exclusive Duplex Rooms give you an open, airy space across two levels — perfect for families who want room to spread out or friends who love gathering in style.
          </p>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Deluxe A/C Room – Your Coastal Hideaway in Alibaug
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="about-text-left">
                <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                 Upstairs, drift into restful sleep in a private bedroom kissed by the sea breeze. Downstairs, kick back in a spacious lounge where morning coffee tastes better with palm-framed views.
                </p>
              </div>

              <div className="about-text-right">
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                  Every Duplex Room comes with modern comforts — chilled drinks from your mini fridge, cool AC, a private washroom, and cozy corners to unwind. Step outside, and you’re just minutes away from Alibaug’s shimmering shoreline.
                </p>
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                  Here, lazy afternoons turn into sunset strolls, and every stay feels like your own coastal home.
                </p>
